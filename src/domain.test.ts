...
const item=(id:string, status:Item['status'], extra:Partial<Item>={}):Item=>({id,title:id,status,kind:'TASK',priority:'NORMAL',events:[],createdAt:'2026-08-01T00:00:00Z',updatedAt:'2026-08-01T00:00:00Z',...extra});
